<template>
  <div class="business-update">
    <el-breadcrumb separator=">">
      ...
      <el-breadcrumb-item :to="{ path: '/businessDetail' }">商家信息</el-breadcrumb-item>
      <el-breadcrumb-item>编辑商家信息</el-breadcrumb-item>
    </el-breadcrumb>
...
export default {
  ...
  methods: {
    ...
    //  获取商家信息
    getmsg() {
      this.axios.post('/customer/tenantInfo/getCurrentTenant', {}).then(response => {
    ...
    handleAvatarProgress(event, file) {
      ...
      this.currentLogo = require('./timg.gif');
    },
    //  头像上传之前
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.axios.post('/customer/tenantInfo/updateTenantInfo', this.ruleForm).then(function(response) {
            ...
            _self.$router.push('/businessDetail');
