<template>
  <div class="register-prod">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="注册状态">
            <el-select class="w240" v-model="query.wmsStatus" size="small">
              <el-option v-for="item of wmsStatusEnum" :label="item.label" :value="item.value" :key="item.value"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    <production-list :search-loading="loading" :sku-data="skuData" :page-size="pageSize" :page-number="pageNumber" @size-change="sizeChangeHandler" @current-change="currentChangeHandler"></production-list>
  </div>
</template>
<script>
import productionList from './RegisterProdList';
