    ...
    <div v-loading="loading">
      <template v-if="data&&data.amount">
        <div class="ticket" v-for="(ticketItem,index) of data.beanList" :key="ticketItem.ticket.ticketId">
          <div class="item-head">
            <div class="ticketmsg">
              <span>入库单号：<span>{{ticketItem.ticket.ticketId}}</span></span>
              ...
              <span>入库时间：<span>{{(ticketItem.ticket.auditTime||ticketItem.ticket.doneTime).slice(0,10)}}</span></span>
